...
export const IconLocation = () => <i className="fi fi-br-marker" />;
...
export const IconRisque = () => <i className="fi fi-br-risk" />;
export const IconPermis = () => <i className="fi fi-br-license" />;
