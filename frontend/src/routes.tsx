...
export const URLS = {
  ...
  LIST_COUCHE: (groupeCoucheId: string) =>
    url`/admin/groupe-couche/${groupeCoucheId}/couches`,
  CREATE_COUCHE: (groupeCoucheId: string) =>
...
export default [
  ...
  },
  {
    ...
    children: [
        ...
        element: (
          <Authorization
            ...
            droits={[
              ...
              TYPE_DROIT.GEST_CONTACT_A,
              TYPE_DROIT.ORGANISME_CONTACT_A,
              TYPE_DROIT.ADMIN_ORGANISME_A,
              TYPE_DROIT.ADMIN_ORGANISME_R,
      ...
      {
        path: "groupe-couche/:groupeCoucheId/couches",
        element: (
          <Authorization
            Component={ListCouche}
            droits={[TYPE_DROIT.ADMIN_COUCHE_CARTOGRAPHIQUE]}
          />
        ),
      },
      {
        path: "groupe-couche/:groupeCoucheId/couche/create",
        element: (
          <Authorization
            Component={CreateCouche}
            droits={[TYPE_DROIT.ADMIN_COUCHE_CARTOGRAPHIQUE]}
          />
        ),
      },
      {
        path: "groupe-couche/:groupeCoucheId/couche/update/:coucheId",
        element: (
          <Authorization
      ...
      {
        path: "groupe-couche/update/:groupeCoucheId",
        element: (
          <Authorization
            Component={UpdateGroupeCouche}
            droits={[TYPE_DROIT.ADMIN_COUCHE_CARTOGRAPHIQUE]}
          />
        ),
      },
      ...
      },
      {
        ...
        element: (
          <Authorization
            ...
            droits={[TYPE_DROIT.ADMIN_DROITS, TYPE_DROIT.ADMIN_ORGANISME_A]}
          />
        ),
      },
      {
      ...
      },
      {
        ...
        element: (
          <Authorization
            ...
            droits={[TYPE_DROIT.ADMIN_DROITS, TYPE_DROIT.ADMIN_UTILISATEURS_A]}
          />
        ),
      },
      {
      ...
      },
      {
        ...
        element: (
          <Authorization
            ...
            droits={[TYPE_DROIT.GEST_CONTACT_A, TYPE_DROIT.ORGANISME_CONTACT_A]}
          />
        ),
      },
      {
