...
export const TypeDroitSection = new Map<TYPE_DROIT, SECTION_DROIT>([
  ...
  [TYPE_DROIT.ETUDE_C, SECTION_DROIT.COUV_HYDRAU],
  [TYPE_DROIT.ETUDE_D, SECTION_DROIT.COUV_HYDRAU],
  [TYPE_DROIT.ETUDE_R, SECTION_DROIT.COUV_HYDRAU],
  [TYPE_DROIT.ETUDE_U, SECTION_DROIT.COUV_HYDRAU],
...
export const TypeDroitLabel = new Map<string, string>([
  ...
  [TYPE_DROIT.ADMIN_UTILISATEURS_R, "Administrer tous les utilisateurs"],
