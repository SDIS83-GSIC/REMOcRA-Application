...
export const TypeDroitSection = new Map<TYPE_DROIT, SECTION_DROIT>([
  ...
  [TYPE_DROIT.RISQUE_KML_A, SECTION_DROIT.RISQUE],
  [TYPE_DROIT.RISQUE_KML_R, SECTION_DROIT.RISQUE],
...
export const TypeDroitLabel = new Map<string, string>([
  ...
  [TYPE_DROIT.RISQUE_KML_A, "Administrer la couche 'Risques express'"],
  [TYPE_DROIT.RISQUE_KML_R, "Consulter la couche 'Risques express'"],
