...
export enum SECTION_DROIT {
  ...
  PEI = "Point d'eau",
  PEI_PRESCRIT = "Point d'eau prescrit",
  PERMIS = "Permis",
...
export const TypeDroitSection = new Map<TYPE_DROIT, SECTION_DROIT>([
  ...
  [TYPE_DROIT.ADMIN_ROP_A, SECTION_DROIT.TOURNEE],
  [TYPE_DROIT.ADMIN_TYPE_ETUDE, SECTION_DROIT.GENERAL],
  [TYPE_DROIT.ADMIN_ORGANISME_R, SECTION_DROIT.GENERAL],
  [TYPE_DROIT.ADMIN_ORGANISME_A, SECTION_DROIT.GENERAL],
  [TYPE_DROIT.ORGANISME_CONTACT_A, SECTION_DROIT.GENERAL],
  ...
  [TYPE_DROIT.DASHBOARD_R, SECTION_DROIT.GENERAL],
  ...
  [TYPE_DROIT.DEPOT_DELIB_C, SECTION_DROIT.SIGNALEMENT],
  ...
  [TYPE_DROIT.DFCI_AIRE_U, SECTION_DROIT.DFCI],
  [TYPE_DROIT.DFCI_PISTE_U, SECTION_DROIT.DFCI],
  [TYPE_DROIT.DFCI_DEB_U, SECTION_DROIT.DFCI],
  [TYPE_DROIT.DFCI_PANNEAU_U, SECTION_DROIT.DFCI],
  [TYPE_DROIT.DFCI_GESTION_CONFLITS_R, SECTION_DROIT.DFCI],
  [TYPE_DROIT.DFCI_GESTION_CONFLITS_A, SECTION_DROIT.DFCI],
  ...
  [TYPE_DROIT.MOBILE_DEPLACER_PEI_U, SECTION_DROIT.MOBILE],
  ...
  [TYPE_DROIT.PEI_PRESCRIT_A, SECTION_DROIT.PEI_PRESCRIT],
  [TYPE_DROIT.PEI_PRESCRIT_R, SECTION_DROIT.PEI_PRESCRIT],
  ...
  [TYPE_DROIT.RAZ_MES_ROP_E, SECTION_DROIT.TOURNEE],
  [TYPE_DROIT.RCCI_A, SECTION_DROIT.RCCI],
  [TYPE_DROIT.RCCI_R, SECTION_DROIT.RCCI],
  [TYPE_DROIT.RISQUE_R, SECTION_DROIT.RISQUE],
  [TYPE_DROIT.RISQUE_EXPRESS_A, SECTION_DROIT.RISQUE],
...
export const TypeDroitLabel = new Map<string, string>([
  ...
  [TYPE_DROIT.ADMIN_ROP_A, "Gérer le cycle de vie des ROP"],
  ...
  [TYPE_DROIT.ADMIN_ORGANISME_A, "Administrer tous les organismes"],
  [TYPE_DROIT.ADMIN_ORGANISME_R, "Consulter tous les organismes"],
  ...
  [TYPE_DROIT.DASHBOARD_A, "Administrer les tableaux de bord"],
  [TYPE_DROIT.DASHBOARD_R, "Consulter le tableau de bord"],
  ...
  [TYPE_DROIT.DFCI_AIRE_U, "Modifier les informations des aires DFCI."],
  [TYPE_DROIT.DFCI_PISTE_U, "Modifier les informations des pistes DFCI."],
  [
    TYPE_DROIT.DFCI_DEB_U,
    "Modifier les informations des débroussaillements DFCI.",
  ],
  [TYPE_DROIT.DFCI_PANNEAU_U, "Modifier les informations des panneaux DFCI."],
  [TYPE_DROIT.DFCI_GESTION_CONFLITS_R, "Voir les conflits de données DFCI."],
  [
    TYPE_DROIT.DFCI_GESTION_CONFLITS_A,
    "Mettre à jour les conflits de données DFCI.",
  ],
  ...
  [TYPE_DROIT.IMPORT_UTILISATEUR_A, "Importer des utilisateurs"],
  [
  ...
  [TYPE_DROIT.MOBILE_DEPLACER_PEI_U, "Déplacer un PEI"],
  [TYPE_DROIT.MOBILE_GESTIONNAIRE_C, "Créer, éditer les gestionnaires"],
  [TYPE_DROIT.MOBILE_PEI_C, "Créer, éditer un PEI"],
  ...
  [TYPE_DROIT.RAZ_MES_ROP_E, "Remettre à zéro l'état des ROP de son organisme"],
  ...
  [TYPE_DROIT.RISQUE_R, "Accéder au module de risque"],
  [TYPE_DROIT.RISQUE_EXPRESS_A, "Administrer la couche 'Risques express'"],
  [TYPE_DROIT.TOURNEE_A, "Créer, éditer, supprimer des tournées"],
  [TYPE_DROIT.TOURNEE_DESAFFECTER_U, "Désaffecter des PEI à des tournées"],
  [
