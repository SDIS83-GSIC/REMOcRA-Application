...
class ExportCtpUseCase : AbstractUseCase() {
    ...
    fun execute(communeId: UUID?, userInfo: WrappedUserInfo): ByteArray {
        ...
        try {
            GlobalConstants.TEMPLATE_EXPORT_CTP_FULL_PATH.inputStream()
            ...
            XSSFWorkbook(inputStream).use { workbook ->
                ...
                while (cpt < pibiDataToExport.size) {
                    ...
                    var currentCell =
                        currentRow.getCell(CELL_CODE_SDIS_INDEX) ?: currentRow.createCell(CELL_CODE_SDIS_INDEX)
                    ...
                    currentCell =
                        currentRow.getCell(CELL_CODE_INSEE_INDEX) ?: currentRow.createCell(CELL_CODE_INSEE_INDEX)
                    ...
                    if (pibiDataToExport[cpt].peiEnFace) {
                        concatAdresse += "En face du "
                    }
                    if (pibiDataToExport[cpt].peiNumeroVoie != null) {
                        concatAdresse += pibiDataToExport[cpt].peiNumeroVoie
                    }
                    if (pibiDataToExport[cpt].peiSuffixeVoie != null) {
                        concatAdresse += pibiDataToExport[cpt].peiSuffixeVoie
                    }
                    concatAdresse += ' '
                    ...
                    currentCell =
                        currentRow.getCell(CELL_LONGITUDE_INDEX) ?: currentRow.createCell(CELL_LONGITUDE_INDEX)
                    ...
                    currentCell =
                        currentRow.getCell(CELL_NATURE_DECI_INDEX) ?: currentRow.createCell(CELL_NATURE_DECI_INDEX)
