...
class CreateRcciUseCase : AbstractCUDGeometrieUseCase<RcciFormInput>(TypeOperation.INSERT) {
    ...
    override fun checkDroits(userInfo: WrappedUserInfo) {
        if (!userInfo.hasDroit(droitWeb = Droit.RCCI_A)) {
            throw RemocraResponseException(ErrorType.RCCI_CREATE_FORBIDDEN)
        }
    }
    ...
    override fun execute(userInfo: WrappedUserInfo, element: RcciFormInput): RcciFormInput {
        rcciRepository.insertRcci(
            Rcci(
                ...
                rcciRcciIndiceRothermelId = element.rcci.rcciRcciIndiceRothermelId,
                ...
                rcciRisqueMeteo = element.rcci.rcciRisqueMeteo,
            ),
        )
