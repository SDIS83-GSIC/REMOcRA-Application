...
constructor(
    ...
    fun getParametresData(): ParametresAdminData {
        ...
        val pei = ParametresSectionPei(
            ...
            peiRenouvellementCtrlIcpe = mapParametres.getIntOrNull(ParametreEnum.PEI_RENOUVELLEMENT_CTRL_ICPE.name),
            peiRenouvellementCtrlIcpeConventionne = mapParametres.getIntOrNull(ParametreEnum.PEI_RENOUVELLEMENT_CTRL_ICPE_CONVENTIONNE.name),
            peiRenouvellementCtrlConventionne = mapParametres.getIntOrNull(ParametreEnum.PEI_RENOUVELLEMENT_CTRL_CONVENTIONNE.name),
            ...
            peiRenouvellementRecoIcpe = mapParametres.getIntOrNull(ParametreEnum.PEI_RENOUVELLEMENT_RECO_ICPE.name),
            ...
            peiRenouvellementRecoConventionne = mapParametres.getIntOrNull(ParametreEnum.PEI_RENOUVELLEMENT_RECO_CONVENTIONNE.name),
