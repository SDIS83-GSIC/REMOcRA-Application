...
class CreateCoucheUseCase
@Inject
constructor(
    private val coucheRepository: CoucheRepository,
    private val objectMapper: ObjectMapper,
) :
    AbstractCUDUseCase<CoucheFormDataWithImage>(TypeOperation.INSERT) {
    ...
    override fun execute(userInfo: WrappedUserInfo, element: CoucheFormDataWithImage): CoucheFormDataWithImage {
        coucheRepository.upsertCouche(
            Couche(
                ...
                coucheFromGeoserver = element.coucheFormData.coucheFromGeoserver.takeIf { element.coucheFormData.coucheSource != SourceCarto.OSM } ?: false,
                coucheOpacite = element.coucheFormData.coucheOpacite.toBigDecimal(),
            ),
        )
