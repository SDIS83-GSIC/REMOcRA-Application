...
@Inject constructor(
    ...
    override fun execute(userInfo: WrappedUserInfo, element: ParametresAdminDataInput): ParametresAdminDataInput {
        ...
        if (userInfo.hasDroit(droitWeb = Droit.ADMIN_PARAM_APPLI)) {
            ...
            updateParametre(
                ParametreEnum.DFCI_LISTE_COUCHE,
                objectMapper.writeValueAsString(parametresAdminData.dfci.dfciListeCouche),
            )
            ...
            updateParametre(
                ParametreEnum.PEI_RENOUVELLEMENT_CTRL_CONVENTIONNE,
                parametresAdminData.pei.peiRenouvellementCtrlConventionne?.toString(),
            )
            updateParametre(
            ...
            updateParametre(
                ParametreEnum.PEI_RENOUVELLEMENT_RECO_CONVENTIONNE,
                parametresAdminData.pei.peiRenouvellementRecoConventionne?.toString(),
            )
            updateParametre(
