...
class CriseEndpoint : AbstractEndpoint() {
    ...
    fun createEvent(
        ...
        return createEventUseCase.execute(
            ...
            EvenementData(
                ...
                evenementSousCategorieId = UUID.fromString(httpRequest.getTextPart("evenementSousCategorieId")),
    ...
    @Public("Les sous catégories d'évènements ne sont pas liées à un droit.")
    fun getEvenementSousCategories(): Response {
        return Response.ok(
