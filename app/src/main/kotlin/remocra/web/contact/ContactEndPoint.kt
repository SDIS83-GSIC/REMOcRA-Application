...
class ContactEndPoint : AbstractEndpoint() {
    ...
    @RequireDroits([Droit.ORGANISME_CONTACT_A, Droit.GEST_CONTACT_A])
    @Produces(MediaType.APPLICATION_JSON)
    fun create(
    ...
    @RequireDroits([Droit.GEST_CONTACT_A, Droit.ORGANISME_CONTACT_A])
    @Produces(MediaType.APPLICATION_JSON)
    fun update(
        @PathParam("appartenanceId")
        appartenanceId: UUID,
    ...
    @POST
    @Path("/{appartenanceId}")
    @RequireDroits([Droit.GEST_CONTACT_A, Droit.ORGANISME_CONTACT_A, Droit.GEST_SITE_R, Droit.ADMIN_ORGANISME_R])
    fun getAllForAdmin(
        @PathParam("appartenanceId")
        appartenanceId: UUID,
