...
class SynchroContactUseCase : AbstractCUDUseCase<ContactForApiMobileData>(TypeOperation.INSERT) {
    ...
    override fun postEvent(element: ContactForApiMobileData, userInfo: UserInfo) {
        // On ne poste pas d'évènement comme c'est une insertion dans le schéma incoming
    }

    override fun execute(userInfo: UserInfo?, element: ContactForApiMobileData): ContactForApiMobileData {
    ...
    override fun checkContraintes(userInfo: UserInfo?, element: ContactForApiMobileData) {
