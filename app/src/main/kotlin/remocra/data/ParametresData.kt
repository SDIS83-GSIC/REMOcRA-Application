...
data class ParametresSectionSignalement(
    val signalementDeliberationDestinataireEmail: String?,
    val signalementDeliberationCorpsEmail: String?,
    val signalementDeliberationObjetEmail: String?,
)
...
data class ParametresSectionDfci(
    ...
    val dfciListeCouche: List<String>?,
)
...
data class ParametresSectionPei(
    ...
    val peiRenouvellementCtrlIcpe: Int?,
    val peiRenouvellementCtrlIcpeConventionne: Int?,
    val peiRenouvellementCtrlConventionne: Int?,
    val peiRenouvellementRecoPrive: Int?,
    val peiRenouvellementRecoPublic: Int?,
    val peiRenouvellementRecoIcpe: Int?,
    val peiRenouvellementRecoIcpeConventionne: Int?,
    val peiRenouvellementRecoConventionne: Int?,
    val peiToleranceCommuneMetres: Int?,
    val peiHighlightDuree: Int?,
    val peiHighlightCouleur: String?,
    val peiHighlightRayon: Int?,
    val peiHighlightLargeur: Int?,
    val peiSelectionCouleur: String?,
    val peiSelectionRayon: Int?,
    val peiSelectionLargeur: Int?,
