...
enum class ParametreEnum(val section: ParametreSection) {
    // SIGNALEMENT
    SIGNALEMENT_DELIBERATION_DESTINATAIRE_EMAIL(ParametreSection.SIGNALEMENT),
    SIGNALEMENT_DELIBERATION_OBJET_EMAIL(ParametreSection.SIGNALEMENT),
    SIGNALEMENT_DELIBERATION_CORPS_EMAIL(ParametreSection.SIGNALEMENT),
    ...
    PEI_HIGHLIGHT_COULEUR(ParametreSection.PEI),
    PEI_HIGHLIGHT_RAYON(ParametreSection.PEI),
    PEI_HIGHLIGHT_LARGEUR(ParametreSection.PEI),
    PEI_SELECTION_COULEUR(ParametreSection.PEI),
    PEI_SELECTION_RAYON(ParametreSection.PEI),
    PEI_SELECTION_LARGEUR(ParametreSection.PEI),
    ...
    PEI_RENOUVELLEMENT_CTRL_ICPE(ParametreSection.PEI),
    PEI_RENOUVELLEMENT_CTRL_ICPE_CONVENTIONNE(ParametreSection.PEI),
    PEI_RENOUVELLEMENT_CTRL_CONVENTIONNE(ParametreSection.PEI),
    PEI_RENOUVELLEMENT_RECO_PRIVE(ParametreSection.PEI),
    PEI_RENOUVELLEMENT_RECO_PUBLIC(ParametreSection.PEI),
    PEI_RENOUVELLEMENT_RECO_ICPE(ParametreSection.PEI),
    PEI_RENOUVELLEMENT_RECO_ICPE_CONVENTIONNE(ParametreSection.PEI),
    PEI_RENOUVELLEMENT_RECO_CONVENTIONNE(ParametreSection.PEI),
    ...
    enum class ParametreSection {
        ALERTE, CARTOGRAPHIE, COURRIER, COUVERTURE_HYDRAULIQUE, DFCI, GENERAL, MOBILE, PEI, PERMIS, RCCI, SIGNALEMENT, UTILISATEUR
    }
}
