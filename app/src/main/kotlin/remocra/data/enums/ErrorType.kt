...
enum class ErrorType(val code: Int, val libelle: String, val status: Status = Status.BAD_REQUEST, val replacement: String? = null) {
    ...
    VISITE_DATE_ALREADY_EXIST(2118, "La visite ne peut être renseignée à la même date et heure qu'une visite déjà existante"),
    ...
    COURRIER_PARAMETRE_NULL(5002, "Le paramètre '$PLACEHOLDER_ERROR_TYPE' est requis et ne peut pas être vide ou null."),
    ...
    ADMIN_ORGANISME_CODE_ALREADY_EXISTS(9012, "Le code doit être unique"),
    ...
    RAPPORT_PERSO_DBF_MAPPING_INVALID(15009, "Mapping DBF introuvable : $PLACEHOLDER_ERROR_TYPE"),
    ...
    GROUPE_FONCTIONNALITES_COUCHE_DELETE(25004, "Vous n'avez pas les droits de suppression des métadonnées de couche", Status.FORBIDDEN),
