...
enum class ErrorType(val code: Int, val libelle: String, val status: Status = Status.BAD_REQUEST, val replacement: String? = null) {
    ...
    API_SYNCHRO_PEI_ERROR(20002, "Impossible d'insérer le PEI ${GlobalConstants.PLACEHOLDER_ERROR_TYPE} dans incoming."),
    API_SYNCHRO_PEI_FORBIDDEN(20003, "Vous n'avez pas les droits de création de PEI depuis l'application mobile.", Status.FORBIDDEN),
    API_SYNCHRO_GESTIONNAIRE_ERROR(20004, "Impossible d'insérer le gestionnaire ${GlobalConstants.PLACEHOLDER_ERROR_TYPE} dans le schéma incoming."),
    API_SYNCHRO_GESTIONNAIRE_FORBIDDEN(20005, "Vous n'avez pas les droits de création de gestionnaire depuis l'application mobile"),
    API_SYNCHRO_GESTIONNAIRE_CONTACT_NO_EXISTE(20006, "Le gestionnaire associé au contact n'est pas dans REMOcRA : ${GlobalConstants.PLACEHOLDER_ERROR_TYPE}"),
    API_SYNCHRO_CONTACT_ERROR(2007, "Impossible d'insérer le contact ${GlobalConstants.PLACEHOLDER_ERROR_TYPE} dans le schéma incoming."),
    API_SYNCHRO_CONTACT_ROLE_NO_EXISTE(2008, "Le contact associé au rôle n'est pas dans REMOcRA : ${GlobalConstants.PLACEHOLDER_ERROR_TYPE}"),
    API_SYNCHRO_CONTACT_ROLE_ERROR(20010, "Impossible d'insérer le contact role dans le schéma incoming."),
    API_SYNCHRO_TOURNEE_ERROR(20011, "Impossible d'insérer la tournée ${GlobalConstants.PLACEHOLDER_ERROR_TYPE} dans le schéma incoming."),
    API_SYNCHRO_VISITE_ERROR(20012, "Impossible d'insérer la visite ${GlobalConstants.PLACEHOLDER_ERROR_TYPE} dans le schéma incoming."),
    API_SYNCHRO_VISITE_PEI_NO_REMOCRA(20013, "Le PEI ${GlobalConstants.PLACEHOLDER_ERROR_TYPE} n'existe pas."),
    API_SYNCHRO_VISITE_ANOMALIE_NO_REMOCRA(20014, "L'anomalie ${GlobalConstants.PLACEHOLDER_ERROR_TYPE} n'existe pas."),
    API_SYNCHRO_VISITE_ANOMALIE_ERROR(20015, "Impossible d'insérer le lien entre l'anomalie et la viste dans le schéma incoming : ${GlobalConstants.PLACEHOLDER_ERROR_TYPE}"),
    API_SYNCHRO_PHOTO_ERROR(20016, "Impossible d'insérer la photo dans le schéma incoming : ${GlobalConstants.PLACEHOLDER_ERROR_TYPE}"),
    ;
