-- Remplacement des libellés RECOP par ROP

-- valeurs présentes dans visite_type_visite de remocra.visite
ALTER TYPE remocra."TYPE_VISITE" RENAME VALUE 'RECOP' TO 'ROP';
-- valeurs présentes dans remocra.type_task
ALTER TYPE remocra."type_task" RENAME VALUE 'NOTIFIER_BDECI_RECOP_DE_LA_JOURNEE' TO 'NOTIFIER_BDECI_ROP_DE_LA_JOURNEE';

-- nom de colonne dans remocra.v_pei_visite_date
DROP VIEW remocra.v_pei_visite_date;
