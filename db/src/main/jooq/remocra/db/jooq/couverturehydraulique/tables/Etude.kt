...
open class Etude(
    ...
    val organisme: OrganismePath by lazy { OrganismePath(this, ETUDE__ETUDE_ETUDE_ORGANISME_ID_FKEY, null) }

    /**
     * Get the implicit join path to the
     * <code>couverturehydraulique.type_etude</code> table.
     */
    fun typeEtude(): TypeEtudePath = typeEtude
    val typeEtude: TypeEtudePath by lazy { TypeEtudePath(this, ETUDE__ETUDE_ETUDE_TYPE_ETUDE_ID_FKEY, null) }
