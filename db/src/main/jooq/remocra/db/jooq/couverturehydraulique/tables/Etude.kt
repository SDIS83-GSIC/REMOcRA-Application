...
import remocra.db.jooq.couverturehydraulique.keys.ETUDE__ETUDE_ETUDE_ORGANISME_FKEY
...
open class Etude(
    ...
    override fun getReferences(): List<ForeignKey<Record, *>> = listOf(ETUDE__ETUDE_ETUDE_TYPE_ETUDE_ID_FKEY, ETUDE__ETUDE_ETUDE_ORGANISME_FKEY)
    ...
    fun organisme(): OrganismePath {
        if (!this::_organisme.isInitialized) {
            _organisme = OrganismePath(this, ETUDE__ETUDE_ETUDE_ORGANISME_FKEY, null)
        }
