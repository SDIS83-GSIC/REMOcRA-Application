...
open class PeiProjet(
    ...
    val diametre: DiametrePath by lazy { DiametrePath(this, PEI_PROJET__PEI_PROJET_PEI_PROJET_DIAMETRE_ID_FKEY, null) }
    ...
    val etude: EtudePath by lazy { EtudePath(this, PEI_PROJET__PEI_PROJET_PEI_PROJET_ETUDE_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>remocra.nature_deci</code> table.
     */
    fun natureDeci(): NatureDeciPath = natureDeci
    val natureDeci: NatureDeciPath by lazy { NatureDeciPath(this, PEI_PROJET__PEI_PROJET_PEI_PROJET_NATURE_DECI_ID_FKEY, null) }
