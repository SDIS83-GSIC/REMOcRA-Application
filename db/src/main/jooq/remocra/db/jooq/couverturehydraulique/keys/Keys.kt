...
val ETUDE__ETUDE_ETUDE_ORGANISME_FKEY: ForeignKey<Record, Record> = Internal.createForeignKey(Etude.ETUDE, DSL.name("etude_etude_organisme_fkey"), arrayOf(Etude.ETUDE.ORGANISME_ID), ORGANISME_PKEY, arrayOf(Organisme.ORGANISME.ID), true)
