...
import remocra.db.jooq.keys.VISITE_CTRL_DEBIT_PRESSION__VISITE_CTRL_DEBIT_PRESSION_VISITE_CTRL_DEBIT_PRESSION_VISI_FKEY
import remocra.db.jooq.keys.VISITE_PKEY
import remocra.db.jooq.keys.VISITE__VISITE_VISITE_PEI_ID_FKEY
import remocra.db.jooq.tables.Anomalie.AnomaliePath
import remocra.db.jooq.tables.LVisiteAnomalie.LVisiteAnomaliePath
import remocra.db.jooq.tables.Pei.PeiPath
import remocra.db.jooq.tables.VisiteCtrlDebitPression.VisiteCtrlDebitPressionPath
...
open class Visite(
     ...
     */
    val DATE: TableField<Record, OffsetDateTime?> = createField(DSL.name("visite_date"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false), this, "")
