...
open class Contact(
    ...
    /**
     * The column <code>remocra.contact.contact_lieu_dit</code>.
     */
    val LIEU_DIT: TableField<Record, String?> = createField(DSL.name("contact_lieu_dit"), SQLDataType.CLOB, this, "")

    /**
     * The column <code>remocra.contact.contact_voie</code>.
     */
    val VOIE: TableField<Record, String?> = createField(DSL.name("contact_voie"), SQLDataType.CLOB, this, "")
    ...
    /**
     * The column <code>remocra.contact.contact_ville</code>.
     */
    val VILLE: TableField<Record, String?> = createField(DSL.name("contact_ville"), SQLDataType.CLOB, this, "")
    ...
    val gestionnaire: GestionnairePath
        get(): GestionnairePath = lContactGestionnaire().lContactGestionnaireGestionnaireIdFkey()
