...
open class Oldeb(
    ...
    val cadastreParcelle: CadastreParcellePath by lazy { CadastreParcellePath(this, OLDEB__OLDEB_OLDEB_CADASTRE_PARCELLE_ID_FKEY, null) }
    ...
    val cadastreSection: CadastreSectionPath by lazy { CadastreSectionPath(this, OLDEB__OLDEB_OLDEB_CADASTRE_SECTION_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>remocra.commune</code> table.
     */
    fun commune(): CommunePath = commune
    val commune: CommunePath by lazy { CommunePath(this, OLDEB__OLDEB_OLDEB_COMMUNE_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>remocra.lieu_dit</code> table.
     */
    fun lieuDit(): LieuDitPath = lieuDit
    val lieuDit: LieuDitPath by lazy { LieuDitPath(this, OLDEB__OLDEB_OLDEB_LIEU_DIT_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>remocra.oldeb_type_acces</code>
     * table.
     */
    fun oldebTypeAcces(): OldebTypeAccesPath = oldebTypeAcces
    val oldebTypeAcces: OldebTypeAccesPath by lazy { OldebTypeAccesPath(this, OLDEB__OLDEB_OLDEB_OLDEB_TYPE_ACCES_ID_FKEY, null) }

    /**
     * Get the implicit join path to the
     * <code>remocra.oldeb_type_zone_urbanisme</code> table.
     */
    fun oldebTypeZoneUrbanisme(): OldebTypeZoneUrbanismePath = oldebTypeZoneUrbanisme
    val oldebTypeZoneUrbanisme: OldebTypeZoneUrbanismePath by lazy { OldebTypeZoneUrbanismePath(this, OLDEB__OLDEB_OLDEB_OLDEB_TYPE_ZONE_URBANISME_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>remocra.voie</code> table.
     */
    fun voie(): VoiePath = voie
    val voie: VoiePath by lazy { VoiePath(this, OLDEB__OLDEB_OLDEB_VOIE_ID_FKEY, null) }
