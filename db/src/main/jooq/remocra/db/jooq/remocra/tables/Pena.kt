...
open class Pena(
     ...
     */
    fun pei(): PeiPath = pei
    val pei: PeiPath by lazy { PeiPath(this, PENA__PENA_PENA_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>remocra.materiau</code> table.
     */
    fun materiau(): MateriauPath = materiau
    val materiau: MateriauPath by lazy { MateriauPath(this, PENA__PENA_PENA_MATERIAU_ID_FKEY, null) }
