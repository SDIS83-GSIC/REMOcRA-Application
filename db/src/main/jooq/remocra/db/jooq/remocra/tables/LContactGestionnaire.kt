...
open class LContactGestionnaire(
    ...
    val contact: ContactPath by lazy { ContactPath(this, L_CONTACT_GESTIONNAIRE__L_CONTACT_GESTIONNAIRE_CONTACT_ID_FKEY, null) }
    ...
    val gestionnaire: GestionnairePath by lazy { GestionnairePath(this, L_CONTACT_GESTIONNAIRE__L_CONTACT_GESTIONNAIRE_GESTIONNAIRE_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>remocra.site</code> table.
     */
    fun site(): SitePath = site
    val site: SitePath by lazy { SitePath(this, L_CONTACT_GESTIONNAIRE__L_CONTACT_GESTIONNAIRE_SITE_ID_FKEY, null) }
