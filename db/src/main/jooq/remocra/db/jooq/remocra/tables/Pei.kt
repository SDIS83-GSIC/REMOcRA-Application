...
import remocra.db.jooq.remocra.tables.Niveau.NiveauPath
...
open class Pei(
    ...
    /**
     * The column <code>remocra.pei.pei_perenne</code>.
     */
    val PERENNE: TableField<Record, Boolean?> = createField(DSL.name("pei_perenne"), SQLDataType.BOOLEAN, this, "")

    /**
     * The column <code>remocra.pei.pei_rotation_6_ccf</code>.
     */
     ...
     */
    fun peiPeiAutoriteDeciIdFkey(): OrganismePath = peiPeiAutoriteDeciIdFkey
    val peiPeiAutoriteDeciIdFkey: OrganismePath by lazy { OrganismePath(this, PEI__PEI_PEI_AUTORITE_DECI_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>remocra.commune</code> table.
     */
    fun commune(): CommunePath = commune
    val commune: CommunePath by lazy { CommunePath(this, PEI__PEI_PEI_COMMUNE_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>remocra.voie</code> table, via
     * the <code>pei_pei_croisement_id_fkey</code> key.
     */
    fun peiPeiCroisementIdFkey(): VoiePath = peiPeiCroisementIdFkey
    val peiPeiCroisementIdFkey: VoiePath by lazy { VoiePath(this, PEI__PEI_PEI_CROISEMENT_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>remocra.domaine</code> table.
     */
    fun domaine(): DomainePath = domaine
    val domaine: DomainePath by lazy { DomainePath(this, PEI__PEI_PEI_DOMAINE_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>remocra.gestionnaire</code>
     * table.
     */
    fun gestionnaire(): GestionnairePath = gestionnaire
    val gestionnaire: GestionnairePath by lazy { GestionnairePath(this, PEI__PEI_PEI_GESTIONNAIRE_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>remocra.lieu_dit</code> table.
     */
    fun lieuDit(): LieuDitPath = lieuDit
    val lieuDit: LieuDitPath by lazy { LieuDitPath(this, PEI__PEI_PEI_LIEU_DIT_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>remocra.organisme</code> table,
     * via the <code>pei_pei_maintenance_deci_id_fkey</code> key.
     */
    fun peiPeiMaintenanceDeciIdFkey(): OrganismePath = peiPeiMaintenanceDeciIdFkey
    val peiPeiMaintenanceDeciIdFkey: OrganismePath by lazy { OrganismePath(this, PEI__PEI_PEI_MAINTENANCE_DECI_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>remocra.nature_deci</code> table.
     */
    fun natureDeci(): NatureDeciPath = natureDeci
    val natureDeci: NatureDeciPath by lazy { NatureDeciPath(this, PEI__PEI_PEI_NATURE_DECI_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>remocra.nature</code> table.
     */
    fun nature(): NaturePath = nature
    val nature: NaturePath by lazy { NaturePath(this, PEI__PEI_PEI_NATURE_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>remocra.niveau</code> table.
     */
    fun niveau(): NiveauPath = niveau
    val niveau: NiveauPath by lazy { NiveauPath(this, PEI__PEI_PEI_NIVEAU_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>remocra.organisme</code> table,
     * via the <code>pei_pei_service_public_deci_id_fkey</code> key.
     */
    fun peiPeiServicePublicDeciIdFkey(): OrganismePath = peiPeiServicePublicDeciIdFkey
    val peiPeiServicePublicDeciIdFkey: OrganismePath by lazy { OrganismePath(this, PEI__PEI_PEI_SERVICE_PUBLIC_DECI_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>remocra.site</code> table.
     */
    fun site(): SitePath = site
    val site: SitePath by lazy { SitePath(this, PEI__PEI_PEI_SITE_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>remocra.voie</code> table, via
     * the <code>pei_pei_voie_id_fkey</code> key.
     */
    fun peiPeiVoieIdFkey(): VoiePath = peiPeiVoieIdFkey
    val peiPeiVoieIdFkey: VoiePath by lazy { VoiePath(this, PEI__PEI_PEI_VOIE_ID_FKEY, null) }
