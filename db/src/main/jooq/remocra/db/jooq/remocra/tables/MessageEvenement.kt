...
open class MessageEvenement(
    ...
    val evenement: EvenementPath by lazy { EvenementPath(this, MESSAGE_EVENEMENT__MESSAGE_EVENEMENT_EVENEMENT_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>remocra.utilisateur</code> table.
     */
    fun utilisateur(): UtilisateurPath = utilisateur
    val utilisateur: UtilisateurPath by lazy { UtilisateurPath(this, MESSAGE_EVENEMENT__MESSAGE_EVENEMENT_UTILISATEUR_ID_FKEY, null) }
