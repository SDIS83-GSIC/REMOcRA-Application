...
import remocra.db.jooq.remocra.keys.VISITE_CTRL_DEBIT_PRESSION_PKEY
...
open class VisiteCtrlDebitPression(
    ...
    companion object {
         ...
         * <code>remocra.visite_ctrl_debit_pression</code>
         */
    ...
    /**
     * The column
     * <code>remocra.visite_ctrl_debit_pression.visite_ctrl_debit_pression_visite_id</code>.
     * UUID de la visite pour laquelle ce contrôle a été réalisé
     */
    val VISITE_ID: TableField<Record, UUID?> = createField(DSL.name("visite_ctrl_debit_pression_visite_id"), SQLDataType.UUID.nullable(false), this, "UUID de la visite pour laquelle ce contrôle a été réalisé")

    /**
     * The column
     * <code>remocra.visite_ctrl_debit_pression.visite_ctrl_debit_pression_debit</code>.
     */
    val DEBIT: TableField<Record, Int?> = createField(DSL.name("visite_ctrl_debit_pression_debit"), SQLDataType.INTEGER, this, "")

    /**
     * The column
     * <code>remocra.visite_ctrl_debit_pression.visite_ctrl_debit_pression_pression</code>.
     */
    ...
    /**
     * The column
     * <code>remocra.visite_ctrl_debit_pression.visite_ctrl_debit_pression_pression_dyn</code>.
     */
    ...
    /**
     * Create an aliased <code>remocra.visite_ctrl_debit_pression</code> table
     * reference
     */
    ...
    /**
     * Create a <code>remocra.visite_ctrl_debit_pression</code> table reference
     */
    ...
    override fun getPrimaryKey(): UniqueKey<Record> = VISITE_CTRL_DEBIT_PRESSION_PKEY
    ...
    val visite: VisitePath by lazy { VisitePath(this, VISITE_CTRL_DEBIT_PRESSION__VISITE_CTRL_DEBIT_PRESSION_VISITE_CTRL_DEBIT_PRESSION_VISI_FKEY, null) }
