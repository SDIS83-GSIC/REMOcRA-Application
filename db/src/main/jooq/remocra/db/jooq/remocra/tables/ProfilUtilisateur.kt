...
open class ProfilUtilisateur(
    ...
    val typeOrganisme: TypeOrganismePath by lazy { TypeOrganismePath(this, PROFIL_UTILISATEUR__PROFIL_UTILISATEUR_PROFIL_UTILISATEUR_TYPE_ORGANISME_ID_FKEY, null) }
