...
open class Permis(
    ...
    val commune: CommunePath by lazy { CommunePath(this, PERMIS__PERMIS_PERMIS_COMMUNE_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>remocra.utilisateur</code> table.
     */
    fun utilisateur(): UtilisateurPath = utilisateur
    val utilisateur: UtilisateurPath by lazy { UtilisateurPath(this, PERMIS__PERMIS_PERMIS_INSTRUCTEUR_ID_FKEY, null) }
    ...
    val typeOrganisme: TypeOrganismePath by lazy { TypeOrganismePath(this, PERMIS__PERMIS_PERMIS_SERVICE_INSTRUCTEUR_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>remocra.type_permis_avis</code>
     * table.
     */
    fun typePermisAvis(): TypePermisAvisPath = typePermisAvis
    val typePermisAvis: TypePermisAvisPath by lazy { TypePermisAvisPath(this, PERMIS__PERMIS_PERMIS_TYPE_PERMIS_AVIS_ID_FKEY, null) }

    /**
     * Get the implicit join path to the
     * <code>remocra.type_permis_interservice</code> table.
     */
    fun typePermisInterservice(): TypePermisInterservicePath = typePermisInterservice
    val typePermisInterservice: TypePermisInterservicePath by lazy { TypePermisInterservicePath(this, PERMIS__PERMIS_PERMIS_TYPE_PERMIS_INTERSERVICE_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>remocra.voie</code> table.
     */
    fun voie(): VoiePath = voie
    val voie: VoiePath by lazy { VoiePath(this, PERMIS__PERMIS_PERMIS_VOIE_ID_FKEY, null) }
