...
open class OldebVisite(
     ...
     * key.
     */
    fun oldebVisiteOldebVisiteDebroussaillementAccesIdFkey(): OldebTypeDebroussaillementPath = oldebVisiteOldebVisiteDebroussaillementAccesIdFkey
    val oldebVisiteOldebVisiteDebroussaillementAccesIdFkey: OldebTypeDebroussaillementPath by lazy { OldebTypeDebroussaillementPath(this, OLDEB_VISITE__OLDEB_VISITE_OLDEB_VISITE_DEBROUSSAILLEMENT_ACCES_ID_FKEY, null) }
     ...
     * key.
     */
    fun oldebVisiteOldebVisiteDebroussaillementParcelleIdFkey(): OldebTypeDebroussaillementPath = oldebVisiteOldebVisiteDebroussaillementParcelleIdFkey
    val oldebVisiteOldebVisiteDebroussaillementParcelleIdFkey: OldebTypeDebroussaillementPath by lazy { OldebTypeDebroussaillementPath(this, OLDEB_VISITE__OLDEB_VISITE_OLDEB_VISITE_DEBROUSSAILLEMENT_PARCELLE_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>remocra.oldeb</code> table.
     */
    fun oldeb(): OldebPath = oldeb
    val oldeb: OldebPath by lazy { OldebPath(this, OLDEB_VISITE__OLDEB_VISITE_OLDEB_VISITE_OLDEB_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>remocra.oldeb_type_action</code>
     * table.
     */
    fun oldebTypeAction(): OldebTypeActionPath = oldebTypeAction
    val oldebTypeAction: OldebTypeActionPath by lazy { OldebTypeActionPath(this, OLDEB_VISITE__OLDEB_VISITE_OLDEB_VISITE_OLDEB_TYPE_ACTION_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>remocra.oldeb_type_avis</code>
     * table.
     */
    fun oldebTypeAvis(): OldebTypeAvisPath = oldebTypeAvis
    val oldebTypeAvis: OldebTypeAvisPath by lazy { OldebTypeAvisPath(this, OLDEB_VISITE__OLDEB_VISITE_OLDEB_VISITE_OLDEB_TYPE_AVIS_ID_FKEY, null) }
