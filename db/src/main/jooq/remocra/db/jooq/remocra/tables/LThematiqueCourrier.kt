...
open class LThematiqueCourrier(
    ...
    val courrier: CourrierPath by lazy { CourrierPath(this, L_THEMATIQUE_COURRIER__L_THEMATIQUE_COURRIER_COURRIER_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>remocra.thematique</code> table.
     */
    fun thematique(): ThematiquePath = thematique
    val thematique: ThematiquePath by lazy { ThematiquePath(this, L_THEMATIQUE_COURRIER__L_THEMATIQUE_COURRIER_THEMATIQUE_ID_FKEY, null) }
