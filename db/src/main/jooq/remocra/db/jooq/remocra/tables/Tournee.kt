...
open class Tournee(
    ...
    val organisme: OrganismePath by lazy { OrganismePath(this, TOURNEE__TOURNEE_TOURNEE_ORGANISME_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>remocra.utilisateur</code> table.
     */
    fun utilisateur(): UtilisateurPath = utilisateur
    val utilisateur: UtilisateurPath by lazy { UtilisateurPath(this, TOURNEE__TOURNEE_TOURNEE_RESERVATION_UTILISATEUR_ID_FKEY, null) }
