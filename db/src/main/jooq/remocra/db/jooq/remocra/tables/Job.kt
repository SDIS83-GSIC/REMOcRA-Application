...
open class Job(
     ...
     */
    fun task(): TaskPath = task
    val task: TaskPath by lazy { TaskPath(this, JOB__JOB_JOB_TASK_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>remocra.utilisateur</code> table.
     */
    fun utilisateur(): UtilisateurPath = utilisateur
    val utilisateur: UtilisateurPath by lazy { UtilisateurPath(this, JOB__JOB_JOB_UTILISATEUR_ID_FKEY, null) }
