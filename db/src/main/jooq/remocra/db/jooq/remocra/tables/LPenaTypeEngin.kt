...
open class LPenaTypeEngin(
    ...
    val pena: PenaPath by lazy { PenaPath(this, L_PENA_TYPE_ENGIN__L_PENA_TYPE_ENGIN_PENA_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>remocra.type_engin</code> table.
     */
    fun typeEngin(): TypeEnginPath = typeEngin
    val typeEngin: TypeEnginPath by lazy { TypeEnginPath(this, L_PENA_TYPE_ENGIN__L_PENA_TYPE_ENGIN_TYPE_ENGIN_ID_FKEY, null) }
