...
open class Rcci(
    ...
    val commune: CommunePath by lazy { CommunePath(this, RCCI__RCCI_RCCI_COMMUNE_ID_FKEY, null) }
     ...
     */
    fun rcciRcciRcciArriveeDdtmOnfIdFkey(): UtilisateurPath = rcciRcciRcciArriveeDdtmOnfIdFkey
    val rcciRcciRcciArriveeDdtmOnfIdFkey: UtilisateurPath by lazy { UtilisateurPath(this, RCCI__RCCI_RCCI_RCCI_ARRIVEE_DDTM_ONF_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>remocra.utilisateur</code> table,
     * via the <code>rcci_rcci_rcci_arrivee_gendarmerie_id_fkey</code> key.
     */
    fun rcciRcciRcciArriveeGendarmerieIdFkey(): UtilisateurPath = rcciRcciRcciArriveeGendarmerieIdFkey
    val rcciRcciRcciArriveeGendarmerieIdFkey: UtilisateurPath by lazy { UtilisateurPath(this, RCCI__RCCI_RCCI_RCCI_ARRIVEE_GENDARMERIE_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>remocra.utilisateur</code> table,
     * via the <code>rcci_rcci_rcci_arrivee_police_id_fkey</code> key.
     */
    fun rcciRcciRcciArriveePoliceIdFkey(): UtilisateurPath = rcciRcciRcciArriveePoliceIdFkey
    val rcciRcciRcciArriveePoliceIdFkey: UtilisateurPath by lazy { UtilisateurPath(this, RCCI__RCCI_RCCI_RCCI_ARRIVEE_POLICE_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>remocra.utilisateur</code> table,
     * via the <code>rcci_rcci_rcci_arrivee_sdis_id_fkey</code> key.
     */
    fun rcciRcciRcciArriveeSdisIdFkey(): UtilisateurPath = rcciRcciRcciArriveeSdisIdFkey
    val rcciRcciRcciArriveeSdisIdFkey: UtilisateurPath by lazy { UtilisateurPath(this, RCCI__RCCI_RCCI_RCCI_ARRIVEE_SDIS_ID_FKEY, null) }

    /**
     * Get the implicit join path to the
     * <code>remocra.rcci_indice_rothermel</code> table.
     */
    fun rcciIndiceRothermel(): RcciIndiceRothermelPath = rcciIndiceRothermel
    val rcciIndiceRothermel: RcciIndiceRothermelPath by lazy { RcciIndiceRothermelPath(this, RCCI__RCCI_RCCI_RCCI_INDICE_ROTHERMEL_ID_FKEY, null) }

    /**
     * Get the implicit join path to the
     * <code>remocra.rcci_type_degre_certitude</code> table.
     */
    fun rcciTypeDegreCertitude(): RcciTypeDegreCertitudePath = rcciTypeDegreCertitude
    val rcciTypeDegreCertitude: RcciTypeDegreCertitudePath by lazy { RcciTypeDegreCertitudePath(this, RCCI__RCCI_RCCI_RCCI_TYPE_DEGRE_CERTITUDE_ID_FKEY, null) }

    /**
     * Get the implicit join path to the
     * <code>remocra.rcci_type_origine_alerte</code> table.
     */
    fun rcciTypeOrigineAlerte(): RcciTypeOrigineAlertePath = rcciTypeOrigineAlerte
    val rcciTypeOrigineAlerte: RcciTypeOrigineAlertePath by lazy { RcciTypeOrigineAlertePath(this, RCCI__RCCI_RCCI_RCCI_TYPE_ORIGINE_ALERTE_ID_FKEY, null) }

    /**
     * Get the implicit join path to the
     * <code>remocra.rcci_type_promethee_categorie</code> table.
     */
    fun rcciTypePrometheeCategorie(): RcciTypePrometheeCategoriePath = rcciTypePrometheeCategorie
    val rcciTypePrometheeCategorie: RcciTypePrometheeCategoriePath by lazy { RcciTypePrometheeCategoriePath(this, RCCI__RCCI_RCCI_RCCI_TYPE_PROMETHEE_CATEGORIE_ID_FKEY, null) }
    ...
    val rcciTypePrometheeFamille: RcciTypePrometheeFamillePath by lazy { RcciTypePrometheeFamillePath(this, RCCI__RCCI_RCCI_RCCI_TYPE_PROMETHEE_FAMILLE_ID_FKEY, null) }
    ...
    val rcciTypePrometheePartition: RcciTypePrometheePartitionPath by lazy { RcciTypePrometheePartitionPath(this, RCCI__RCCI_RCCI_RCCI_TYPE_PROMETHEE_PARTITION_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>remocra.utilisateur</code> table,
     * via the <code>rcci_rcci_utilisateur_id_fkey</code> key.
     */
    fun rcciRcciUtilisateurIdFkey(): UtilisateurPath = rcciRcciUtilisateurIdFkey
    val rcciRcciUtilisateurIdFkey: UtilisateurPath by lazy { UtilisateurPath(this, RCCI__RCCI_RCCI_UTILISATEUR_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>remocra.voie</code> table.
     */
    fun voie(): VoiePath = voie
    val voie: VoiePath by lazy { VoiePath(this, RCCI__RCCI_RCCI_VOIE_ID_FKEY, null) }
