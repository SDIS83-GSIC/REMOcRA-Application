...
open class Pibi(
    ...
    val diametre: DiametrePath by lazy { DiametrePath(this, PIBI__PIBI_PIBI_DIAMETRE_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>remocra.pei</code> table.
     */
    fun pei(): PeiPath = pei
    val pei: PeiPath by lazy { PeiPath(this, PIBI__PIBI_PIBI_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>remocra.pibi</code> table.
     */
    fun pibi(): PibiPath = pibi
    val pibi: PibiPath by lazy { PibiPath(this, PIBI__PIBI_PIBI_JUMELE_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>remocra.marque_pibi</code> table.
     */
    fun marquePibi(): MarquePibiPath = marquePibi
    val marquePibi: MarquePibiPath by lazy { MarquePibiPath(this, PIBI__PIBI_PIBI_MARQUE_PIBI_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>remocra.modele_pibi</code> table.
     */
    fun modelePibi(): ModelePibiPath = modelePibi
    val modelePibi: ModelePibiPath by lazy { ModelePibiPath(this, PIBI__PIBI_PIBI_MODELE_PIBI_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>remocra.pena</code> table.
     */
    fun pena(): PenaPath = pena
    val pena: PenaPath by lazy { PenaPath(this, PIBI__PIBI_PIBI_PENA_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>remocra.reservoir</code> table.
     */
    fun reservoir(): ReservoirPath = reservoir
    val reservoir: ReservoirPath by lazy { ReservoirPath(this, PIBI__PIBI_PIBI_RESERVOIR_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>remocra.organisme</code> table.
     */
    fun organisme(): OrganismePath = organisme
    val organisme: OrganismePath by lazy { OrganismePath(this, PIBI__PIBI_PIBI_SERVICE_EAU_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>remocra.type_canalisation</code>
     * table.
     */
    fun typeCanalisation(): TypeCanalisationPath = typeCanalisation
    val typeCanalisation: TypeCanalisationPath by lazy { TypeCanalisationPath(this, PIBI__PIBI_PIBI_TYPE_CANALISATION_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>remocra.type_reseau</code> table.
     */
    fun typeReseau(): TypeReseauPath = typeReseau
    val typeReseau: TypeReseauPath by lazy { TypeReseauPath(this, PIBI__PIBI_PIBI_TYPE_RESEAU_ID_FKEY, null) }
