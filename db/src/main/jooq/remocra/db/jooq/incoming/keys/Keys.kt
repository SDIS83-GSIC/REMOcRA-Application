...
val CONTACT__CONTACT_CONTACT_COMMUNE_ID_FKEY: ForeignKey<Record, Record> = Internal.createForeignKey(Contact.CONTACT, DSL.name("contact_contact_commune_id_fkey"), arrayOf(Contact.CONTACT.COMMUNE_ID), COMMUNE_PKEY, arrayOf(Commune.COMMUNE.ID), true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION)
val CONTACT__CONTACT_CONTACT_FONCTION_CONTACT_ID_FKEY: ForeignKey<Record, Record> = Internal.createForeignKey(Contact.CONTACT, DSL.name("contact_contact_fonction_contact_id_fkey"), arrayOf(Contact.CONTACT.FONCTION_CONTACT_ID), FONCTION_CONTACT_PKEY, arrayOf(FonctionContact.FONCTION_CONTACT.ID), true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION)
val CONTACT__CONTACT_CONTACT_LIEU_DIT_ID_FKEY: ForeignKey<Record, Record> = Internal.createForeignKey(Contact.CONTACT, DSL.name("contact_contact_lieu_dit_id_fkey"), arrayOf(Contact.CONTACT.LIEU_DIT_ID), LIEU_DIT_PKEY, arrayOf(LieuDit.LIEU_DIT.ID), true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION)
val CONTACT__CONTACT_CONTACT_VOIE_ID_FKEY: ForeignKey<Record, Record> = Internal.createForeignKey(Contact.CONTACT, DSL.name("contact_contact_voie_id_fkey"), arrayOf(Contact.CONTACT.VOIE_ID), VOIE_PKEY, arrayOf(Voie.VOIE.ID), true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION)
val CONTACT__CONTACT_GESTIONNAIRE_ID_FKEY: ForeignKey<Record, Record> = Internal.createForeignKey(Contact.CONTACT, DSL.name("contact_gestionnaire_id_fkey"), arrayOf(Contact.CONTACT.GESTIONNAIRE_ID), remocra.db.jooq.incoming.keys.GESTIONNAIRE_PKEY, arrayOf(Gestionnaire.GESTIONNAIRE.ID), true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION)
val L_CONTACT_ROLE__L_CONTACT_ROLE_CONTACT_ID_FKEY: ForeignKey<Record, Record> = Internal.createForeignKey(LContactRole.L_CONTACT_ROLE, DSL.name("l_contact_role_contact_id_fkey"), arrayOf(LContactRole.L_CONTACT_ROLE.CONTACT_ID), remocra.db.jooq.incoming.keys.CONTACT_PKEY, arrayOf(Contact.CONTACT.ID), true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION)
val L_CONTACT_ROLE__L_CONTACT_ROLE_ROLE_ID_FKEY: ForeignKey<Record, Record> = Internal.createForeignKey(LContactRole.L_CONTACT_ROLE, DSL.name("l_contact_role_role_id_fkey"), arrayOf(LContactRole.L_CONTACT_ROLE.ROLE_ID), ROLE_PKEY, arrayOf(RoleContact.ROLE_CONTACT.ID), true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION)
val L_VISITE_ANOMALIE__L_VISITE_ANOMALIE_ANOMALIE_ID_FKEY: ForeignKey<Record, Record> = Internal.createForeignKey(LVisiteAnomalie.L_VISITE_ANOMALIE, DSL.name("l_visite_anomalie_anomalie_id_fkey"), arrayOf(LVisiteAnomalie.L_VISITE_ANOMALIE.ANOMALIE_ID), ANOMALIE_PKEY, arrayOf(Anomalie.ANOMALIE.ID), true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION)
val L_VISITE_ANOMALIE__L_VISITE_ANOMALIE_VISITE_ID_FKEY: ForeignKey<Record, Record> = Internal.createForeignKey(LVisiteAnomalie.L_VISITE_ANOMALIE, DSL.name("l_visite_anomalie_visite_id_fkey"), arrayOf(LVisiteAnomalie.L_VISITE_ANOMALIE.VISITE_ID), remocra.db.jooq.incoming.keys.VISITE_PKEY, arrayOf(Visite.VISITE.ID), true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION)
val NEW_PEI__NEW_PEI_NEW_PEI_COMMUNE_ID_FKEY: ForeignKey<Record, Record> = Internal.createForeignKey(NewPei.NEW_PEI, DSL.name("new_pei_new_pei_commune_id_fkey"), arrayOf(NewPei.NEW_PEI.COMMUNE_ID), COMMUNE_PKEY, arrayOf(Commune.COMMUNE.ID), true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION)
val NEW_PEI__NEW_PEI_NEW_PEI_DOMAINE_ID_FKEY: ForeignKey<Record, Record> = Internal.createForeignKey(NewPei.NEW_PEI, DSL.name("new_pei_new_pei_domaine_id_fkey"), arrayOf(NewPei.NEW_PEI.DOMAINE_ID), DOMAINE_PKEY, arrayOf(Domaine.DOMAINE.ID), true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION)
val NEW_PEI__NEW_PEI_NEW_PEI_GESTIONNAIRE_ID_FKEY: ForeignKey<Record, Record> = Internal.createForeignKey(NewPei.NEW_PEI, DSL.name("new_pei_new_pei_gestionnaire_id_fkey"), arrayOf(NewPei.NEW_PEI.GESTIONNAIRE_ID), remocra.db.jooq.remocra.keys.GESTIONNAIRE_PKEY, arrayOf(remocra.db.jooq.remocra.tables.Gestionnaire.GESTIONNAIRE.ID), true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION)
val NEW_PEI__NEW_PEI_NEW_PEI_LIEU_DIT_ID_FKEY: ForeignKey<Record, Record> = Internal.createForeignKey(NewPei.NEW_PEI, DSL.name("new_pei_new_pei_lieu_dit_id_fkey"), arrayOf(NewPei.NEW_PEI.LIEU_DIT_ID), LIEU_DIT_PKEY, arrayOf(LieuDit.LIEU_DIT.ID), true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION)
