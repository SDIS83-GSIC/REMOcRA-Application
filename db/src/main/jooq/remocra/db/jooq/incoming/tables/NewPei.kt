...
open class NewPei(
    ...
    val commune: CommunePath by lazy { CommunePath(this, NEW_PEI__NEW_PEI_NEW_PEI_COMMUNE_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>remocra.domaine</code> table.
     */
    fun domaine(): DomainePath = domaine
    val domaine: DomainePath by lazy { DomainePath(this, NEW_PEI__NEW_PEI_NEW_PEI_DOMAINE_ID_FKEY, null) }
    ...
    val gestionnaire: GestionnairePath by lazy { GestionnairePath(this, NEW_PEI__NEW_PEI_NEW_PEI_GESTIONNAIRE_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>remocra.lieu_dit</code> table.
     */
    fun lieuDit(): LieuDitPath = lieuDit
    val lieuDit: LieuDitPath by lazy { LieuDitPath(this, NEW_PEI__NEW_PEI_NEW_PEI_LIEU_DIT_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>remocra.nature_deci</code> table.
     */
    fun natureDeci(): NatureDeciPath = natureDeci
    val natureDeci: NatureDeciPath by lazy { NatureDeciPath(this, NEW_PEI__NEW_PEI_NEW_PEI_NATURE_DECI_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>remocra.nature</code> table.
     */
    fun nature(): NaturePath = nature
    val nature: NaturePath by lazy { NaturePath(this, NEW_PEI__NEW_PEI_NEW_PEI_NATURE_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>remocra.voie</code> table.
     */
    fun voie(): VoiePath = voie
    val voie: VoiePath by lazy { VoiePath(this, NEW_PEI__NEW_PEI_NEW_PEI_VOIE_ID_FKEY, null) }
