...
open class Contact(
    ...
    val commune: CommunePath by lazy { CommunePath(this, CONTACT__CONTACT_CONTACT_COMMUNE_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>remocra.fonction_contact</code>
     * table.
     */
    fun fonctionContact(): FonctionContactPath = fonctionContact
    val fonctionContact: FonctionContactPath by lazy { FonctionContactPath(this, CONTACT__CONTACT_CONTACT_FONCTION_CONTACT_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>remocra.lieu_dit</code> table.
     */
    fun lieuDit(): LieuDitPath = lieuDit
    val lieuDit: LieuDitPath by lazy { LieuDitPath(this, CONTACT__CONTACT_CONTACT_LIEU_DIT_ID_FKEY, null) }

    /**
     * Get the implicit join path to the <code>remocra.voie</code> table.
     */
    fun voie(): VoiePath = voie
    val voie: VoiePath by lazy { VoiePath(this, CONTACT__CONTACT_CONTACT_VOIE_ID_FKEY, null) }
    ...
    val gestionnaire: GestionnairePath by lazy { GestionnairePath(this, CONTACT__CONTACT_GESTIONNAIRE_ID_FKEY, null) }
