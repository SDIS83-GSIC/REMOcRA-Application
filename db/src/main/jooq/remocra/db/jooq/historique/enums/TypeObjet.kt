...
enum class TypeObjet(@get:JvmName("literal") public val literal: String) : EnumType {
    ...
    GROUPE_FONCTIONNALITES("GROUPE_FONCTIONNALITES"),
    ...
    SIGNALEMENT_ELEMENT("SIGNALEMENT_ELEMENT"),
    PERMIS("PERMIS"),
    ...
    SIGNALEMENT_SOUS_TYPE_ELEMENT("SIGNALEMENT_SOUS_TYPE_ELEMENT"),
    EVENEMENT_CATEGORIE("EVENEMENT_CATEGORIE"),
    TYPE_CRISE("TYPE_CRISE"),
    EVENEMENT_SOUS_CATEGORIE("EVENEMENT_SOUS_CATEGORIE"),
